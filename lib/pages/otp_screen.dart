...
import 'package:dcs_wallet/pages/user_information_screen.dart';
import 'package:dcs_wallet/util/custom_button.dart';
import 'package:dcs_wallet/util/utils.dart';
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Image.asset('lib/icons/dcs_logo.png'),
                    ),
                    ...
                    const SizedBox(height: 20),
                    const Text("Did't receive any code?",
                        style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                            color: Colors.black38)),
